        ...
        <div className={style.vacationWrapper}>
            <div className={style.topString}>
                <span className={style.iconDepartment}>
                    { props.icon == 'call-centr' ? phone
                        : props.icon == 'Выездное взыскание'? goOut
                        : props.icon == 'УСВД'? usvd
                        : props.icon == 'ДВВиИП'? dvviip
                        : props.icon == 'УМИОП'? umiop
                        : props.icon == 'УР'? ur
                        : props.icon == 'УСВ'? usv : udviip }
                </span>
                <h4>{ vocationDepartmentLength(props.department) }</h4>
                <h2>{ vocationTitleLength(props.vacation) }</h2>
                <p>{ vocationTextLength(props.decription) }</p>

                <NavLink to='/vacationForm' className={style.btn}>Оставить заявку</NavLink>
            </div>
        </div>
    )
}
